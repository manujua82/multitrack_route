var App = (function () {
  ...
  App.dataTables = function( ){
    ...
    $('.dataTables_filter input').addClass('form-control').attr('Label','Buscar');
    ...
    $("#datatable-icons tbody tr td:last-child").each(function(){
     ...
     /* Formating function for row details */
      function fnFormatDetails ( oTable, nTr )
      {
          ...
          sOut += '<tr><td style="width:2%;"><input type="checkbox"></td><td>Nancy Perez</td><td>'+aData[1]+' '+aData[4]+'</td></tr>';
          sOut += '<tr><td style="width:2%;"><input type="checkbox"></td><td>Francisco Rivero</td><td>Maracay, Venezuela</td></tr>';
          sOut += '<tr><td style="width:2%;"><input type="checkbox"></td><td>Francisco Jose Rivero</td><td>Mucuruba, Venezuela</td></tr>';
          sOut += '</table>';
    ...
    $('.dataTables_filter input').addClass('form-control').attr('label','Search1');
    $('.dataTables_length select').addClass('form-control');
