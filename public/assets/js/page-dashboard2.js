    ...
    /*VectorMaps*/
      $('#world-map').vectorMap({
        ...
        markerStyle:{
          ...
          markers: [
              {latLng: [27.909486, -82.787304], name: 'Consolidado 7', style: {fill: '#E44C34',stroke:'rgba(255,255,255,0.7)',"stroke-width": 3}},
              {latLng: [25.76032,  -80.175476], name: 'Consolidado 6', style: {fill: '#E44C34',stroke:'rgba(255,255,255,0.7)',"stroke-width": 3}},
              {latLng: [ 22.187405, -75.476074], name: 'Consolidado 5', style: {fill: '#E44C34',stroke:'rgba(255,255,255,0.7)',"stroke-width": 3}},
              {latLng: [ 10.228437, -66.928711], name: 'Consolidado 4', style: {fill: '#E44C34',stroke:'rgba(255,255,255,0.7)',"stroke-width": 3}},
